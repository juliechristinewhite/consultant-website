...
function alert($title, $content) {
	echo "<div class='alert'><h3>Testing 123</h3><p>This is the content</p></div>";
}

function alert_func( $passedValues ) {
    $attributes = shortcode_atts( array(
        'title' => 'Alert!', // default Title
        'content' => '', // Default Content (nothing)
    ), $passedValues );

    return "<div class='alert'><h3>".$attributes['title']."</h3><p>".$attributes['content']."</p></div>";
}
